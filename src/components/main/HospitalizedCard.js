...
const HospitalizedCard = () => {
  ...
  return (
    <div>
      <div
        className={`card text-white bg-danger mb-3 mt-3 m-auto text-center align-content-center`}
        style={{ width: "30vw" }}
      >
        <div className="card-header">Total Hospitalized Cases</div>
